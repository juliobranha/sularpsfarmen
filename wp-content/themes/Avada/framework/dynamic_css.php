...
<?php if($data['slidingbar_widgets']): ?>
...
#slidingbar-area .pyre_tabs .tab-holder .tabs li {
	border-color: <?php echo $rgb ?> !important;
	border-color: <?php echo $rgba ?> !important;
}
<?php if($data['slidingbar_top_border']): ?>
#slidingbar-area {
...
<?php if($data['header_sticky_nav_padding']): ?>
.sticky-header #sticky-nav ul li { padding-right: <?php echo $data['header_sticky_nav_padding']; ?>px; }
.sticky-header #sticky-nav ul li ul li { padding-right: 0; }
<?php endif; ?>

<?php if($data['header_sticky_nav_font_size']): ?>
.sticky-header #sticky-nav > ul > li a { font-size: <?php echo $data['header_sticky_nav_font_size']; ?>px; }
.sticky-header .cart-checkout .cart-link a, .sticky-header .cart-checkout .checkout-link a { font-size: 12px !important; }
<?php endif; ?>

<?php if($data['header_sticky_bg_color']): ?>
<?php $header_sticky_bg_color_hex = avada_hex2rgb($data['header_sticky_bg_color']); ?>

<?php if($data['header_sticky_opacity']): ?>
body #header-sticky.sticky-header .sticky-shadow{background:rgba(<?php echo $header_sticky_bg_color_hex[0]; ?>, <?php echo $header_sticky_bg_color_hex[1]; ?>, <?php echo $header_sticky_bg_color_hex[2]; ?>, <?php echo $data['header_sticky_opacity']; ?>) !important;}
.no-rgba #header-sticky.sticky-header .sticky-shadow{background:<?php echo $data['header_sticky_bg_color']; ?>; filter: progid: DXImageTransform.Microsoft.Alpha(Opacity=<?php echo $data['header_sticky_opacity']*100; ?>); opacity: <?php echo $data['header_sticky_opacity']; ?>;}
<?php else: ?>
body #header-sticky.sticky-header .sticky-shadow{background:rgba(<?php echo $header_sticky_bg_color_hex[0]; ?>, <?php echo $header_sticky_bg_color_hex[1]; ?>, <?php echo $header_sticky_bg_color_hex[2]; ?>, 0.97) !important;}
.no-rgba #header-sticky.sticky-header .sticky-shadow{background:<?php echo $data['header_sticky_bg_color']; ?>; filter: progid: DXImageTransform.Microsoft.Alpha(Opacity=97); opacity: 0.97;}
<?php endif; ?>
<?php else: ?>
...
<?php $header_bg_color_hex = avada_hex2rgb($data['header_bg_color']); ?>
...
.footer-area .pyre_tabs .tab-holder .tabs li {
	border-color:<?php echo $data['footer_bg_color']; ?> !important;
}
<?php endif; ?>
...
<?php endif; ?>
<?php if($data['button_gradient_top_color_hover'] && $data['button_gradient_bottom_color_hover'] && $data['button_gradient_text_color']): ?>
...
.woocommerce .avada-order-details .order-again .button:hover{
	background: <?php echo $data['button_gradient_top_color_hover']; ?>;
	color: <?php echo $data['button_gradient_text_color']; ?> !important;
	background-image: linear-gradient(top, <?php echo $data['button_gradient_top_color_hover']; ?> 0%, <?php echo $data['button_gradient_bottom_color_hover']; ?> 100%);
	background-image: -o-linear-gradient(top, <?php echo $data['button_gradient_top_color_hover']; ?> 0%, <?php echo $data['button_gradient_bottom_color_hover']; ?> 100%);
	background-image: -moz-linear-gradient(top, <?php echo $data['button_gradient_top_color_hover']; ?> 0%, <?php echo $data['button_gradient_bottom_color_hover']; ?> 100%);
	background-image: -webkit-linear-gradient(top, <?php echo $data['button_gradient_top_color_hover']; ?> 0%, <?php echo $data['button_gradient_bottom_color_hover']; ?> 100%);
	background-image: -ms-linear-gradient(top, <?php echo $data['button_gradient_top_color_hover']; ?> 0%, <?php echo $data['button_gradient_bottom_color_hover']; ?> 100%);

	background-image: -webkit-gradient(
		linear,
		left top,
		left bottom,
		color-stop(0, <?php echo $data['button_gradient_top_color_hover']; ?>),
		color-stop(1, <?php echo $data['button_gradient_bottom_color_hover']; ?>)
	);
	border:1px solid <?php echo $data['button_gradient_top_color_hover']; ?>;

	filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='<?php echo $data['button_gradient_top_color_hover']; ?>', endColorstr='<?php echo $data['button_gradient_bottom_color_hover']; ?>');
}
...
.footer-area{
	...
	<?php if($data['footerw_bg_pos']): ?>
	background-position:<?php echo $data['footerw_bg_pos']; ?>;
	<?php endif; ?>
	...
	<?php if($data['footer_area_bg_parallax']): ?>
	background-attachment: fixed !important;
	background-position:top center;
	<?php endif; ?>
	<?php endif; ?>

	<?php if($data['footer_area_top_padding']): ?>
	padding-top: <?php echo $data['footer_area_top_padding']; ?> !important;
	<?php endif; ?>

	<?php if($data['footer_area_bottom_padding']): ?>
	padding-bottom: <?php echo $data['footer_area_bottom_padding']; ?> !important;
	<?php endif; ?>
}

#footer{
	<?php if($data['copyright_top_padding']): ?>
	padding-top: <?php echo $data['copyright_top_padding']; ?> !important;
	<?php endif; ?>

	<?php if($data['copyright_bottom_padding']): ?>
	padding-bottom: <?php echo $data['copyright_bottom_padding']; ?> !important;
	<?php endif; ?>
}
...
.blog-shortcode h3.timeline-title { font-size:<?php echo $data['body_font_size']; ?>px;line-height:<?php echo $data['body_font_size']; ?>px; }
.counter-box-content { font-size:<?php echo $data['body_font_size']; ?>px; }
<?php endif; ?>
...
#nav,#sticky-nav,.navigation{font-size:<?php echo $data['nav_font_size']; ?>px !important;}
<?php endif; ?>

<?php if($data['nav_dropdown_font_size']): ?>
#nav ul li ul li a,#sticky-nav ul li ul li a{font-size:<?php echo $data['nav_dropdown_font_size']; ?>px !important;}
<?php endif; ?>
...
<?php if($data['megamenu_title_size']): ?>
#wrapper .fusion-megamenu-wrapper .fusion-megamenu-title{font-size:<?php echo $data['megamenu_title_size']; ?>!important;}
<?php endif; ?>
...
p.demo_store { font-size:<?php echo $data['h3_font_size']; ?>px !important; }
<?php endif; ?>
...
.quantity .qty,.quantity .minus,.quantity .plus,.blog-shortcode h3.timeline-title, #reviews #comments > h2{color:<?php echo $data['body_text_color']; ?> !important;}
<?php endif; ?>
...
{color:<?php echo $data['link_color']; ?> !important;}
<?php endif; ?>
...
#slidingbar-area,#slidingbar-area article.col,#slidingbar-area #jtwt,#slidingbar-area #jtwt .jtwt_tweet{color:<?php echo $data['slidingbar_text_color']; ?> !important;}
<?php endif; ?>
...
<?php if($data['sidebar_heading_color']): ?>
#sidebar .widget h3, #sidebar .widget .heading h3{color:<?php echo $data['sidebar_heading_color']; ?> !important;}
<?php endif; ?>
...
.footer-area,.footer-area article.col,.footer-area #jtwt,.footer-area #jtwt .jtwt_tweet,.copyright{color:<?php echo $data['footer_text_color']; ?> !important;}
<?php endif; ?>

<?php if($data['footer_link_color']): ?>
.footer-area a,.footer-area .pyre_tabs .tab-holder .tabs li a,.copyright a{color:<?php echo $data['footer_link_color']; ?> !important;}
<?php endif; ?>
...
{color:<?php echo $data['menu_first_color']; ?> !important;}
#header-sticky .my-account-link:after, #header .my-account-link:after{border-color:<?php echo $data['menu_first_color']; ?> !important;}
<?php endif; ?>
...
{color:<?php echo $data['menu_hover_first_color']; ?> !important;border-color:<?php echo $data['menu_hover_first_color']; ?> !important;}
#nav ul ul,#sticky-nav ul ul{border-color:<?php echo $data['menu_hover_first_color']; ?> !important;}
...
#wrapper #nav ul li ul li a,#wrapper #sticky-nav ul li ul li a,.side-nav li li a,.side-nav li.current_page_item li a,#wrapper .fusion-megamenu-wrapper .fusion-megamenu-widgets-container{color:<?php echo $data['menu_sub_color']; ?> !important;}
.fusion-megamenu-bullet {border-right-color:<?php echo $data['menu_sub_color']; ?> !important;}
<?php endif; ?>
...
#wrapper .header-social .header-info, #wrapper .header-social a {color:<?php echo $data['snav_color']; ?> !important;}
...
{border-color:<?php echo $data['sep_color']; ?>;}
...
{border-color:<?php echo $data['sep_color']; ?> !important;}
...
#slidingbar-area .tagcloud a, #slidingbar-area .pyre_tabs .tab-holder .tabs-wrapper, #slidingbar-area .pyre_tabs .tab-holder .news-list li {border-color: <?php echo $data['slidingbar_divider_color']; ?> !important;}
<?php endif; ?>

<?php if($data['footer_divider_color']): ?>
.footer-area .widget_categories li a, .footer-area li.recentcomments, .footer-area ul li a, .footer-area .product_list_widget li,
.footer-area .tagcloud a,.footer-area .pyre_tabs .tab-holder .tabs-wrapper, .footer-area .pyre_tabs .tab-holder .news-list li {border-color: <?php echo $data['footer_divider_color']; ?> !important;}
<?php endif; ?>
...
{
background-color:<?php echo $data['form_bg_color']; ?> !important;}
<?php endif; ?>
...
{color:<?php echo $data['form_text_color']; ?> !important;}
...
{border-bottom:1px solid <?php echo $data['menu_sub_sep_color']; ?> !important;}
<?php endif; ?>
...
{background-color:<?php echo $data['menu_bg_hover_color']; ?> !important;}
<?php endif; ?>
...
.rtl #header-sticky #nav ul ul li ul,.rtl #header #nav ul ul li ul,.rtl #small-nav #nav ul ul li ul, .rtl .sticky-header #sticky-nav ul ul li ul{
	right:<?php echo $data['dropdown_menu_width']; ?> !important;
	left: auto !important;
}
...
#sidebar .pyre_tabs .tabs-container{background-color:<?php echo $data['tabs_bg_color']; ?> !important;}
...
.bbp-arrow, #bbpress-forums .quicktags-toolbar { background-color:<?php echo $data['content_bg_color']; ?> !important; }
...
.mobile-nav-holder .mobile-selector, .mobile-topnav-holder .mobile-selector,#mobile-nav { background-image: none !important; background-color: <?php echo $data['form_bg_color']; ?>!important; }
...
#wrapper .fusion-megamenu-wrapper .fusion-megamenu-submenu,#nav .fusion-navbar-nav .fusion-megamenu-wrapper ul ul, #sticky-nav .fusion-navbar-nav .fusion-megamenu-wrapper ul ul {
	border-color: <?php echo $data['menu_sub_sep_color']; ?> !important;
}
#wrapper .fusion-megamenu-wrapper .fusion-megamenu-holder {
	background-color: <?php echo $data['menu_sub_bg_color']; ?> !important;
}
#wrapper .fusion-megamenu-wrapper .fusion-megamenu-title { 
	color: <?php echo $data['menu_first_color']; ?> !important;
}
#wrapper .fusion-megamenu-wrapper .fusion-megamenu-bullet, .fusion-megamenu-bullet {
    border-left-color: <?php echo $data['menu_sub_color']; ?> !important;
}
...
<?php if($data['form_bg_color'] && $data['form_content_color'] && $data['form_border_color']): ?>
.quicktags-toolbar input {
    background: linear-gradient(to top, <?php echo $data['content_bg_color']; ?>, <?php echo $data['form_bg_color']; ?> ) #3E3E3E !important;
    background: -o-linear-gradient(to top, <?php echo $data['content_bg_color']; ?>, <?php echo $data['form_bg_color']; ?> ) #3E3E3E !important;
    background: -moz-linear-gradient(to top, <?php echo $data['content_bg_color']; ?>, <?php echo $data['form_bg_color']; ?> ) #3E3E3E !important;
    background: -webkit-linear-gradient(to top, <?php echo $data['content_bg_color']; ?>, <?php echo $data['form_bg_color']; ?> ) #3E3E3E !important;
    background: -ms-linear-gradient(to top, <?php echo $data['content_bg_color']; ?>, <?php echo $data['form_bg_color']; ?> ) #3E3E3E !important;
    background: linear-gradient(to top, <?php echo $data['content_bg_color']; ?>, <?php echo $data['form_bg_color']; ?> ) #3E3E3E !important;
	...
	background-image: -webkit-gradient(
		...
		left top,
		left bottom,
		color-stop(0, <?php echo $data['form_bg_color']; ?>),
		color-stop(1, <?php echo $data['content_bg_color']; ?>)
	);
	filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='<?php echo $data['form_bg_color']; ?>', endColorstr='<?php echo $data['content_bg_color']; ?>')
			progid: DXImageTransform.Microsoft.Alpha(Opacity=0);

    border: 1px solid <?php echo $data['form_border_color'] ?> !important;
    color: <?php echo $data['form_text_color']; ?> !important;
}
...
#nav.nav-holder .navigation > li > a{height:<?php echo $data['nav_height']; ?>px !important;line-height:<?php echo $data['nav_height']; ?>px !important;}
#nav ul ul,#sticky-nav ul ul{top:<?php echo $data['nav_height']+3; ?>px;}
<?php endif; ?>

<?php if($data['nav_padding']): ?>
#nav ul li, #sticky-nav ul li { padding-right: <?php echo $data['nav_padding']; ?>px; }
<?php endif; ?>
...
.button,.gform_wrapper .gform_button{border-color:<?php echo $data['button_border_color']; ?> !important;}
<?php endif; ?>

<?php if($data['button_border_width']): ?>
.button,.gform_wrapper .gform_button{border-width:<?php echo $data['button_border_width']; ?> !important;}
<?php endif; ?>
...
<?php if($data['header_v4_content'] == 'Search'): ?>
...
<?php if($data['woocommerce_one_page_checkout']): ?>
