...
<head>
	...
	body{
		...
		background-repeat:<?php echo get_post_meta($c_pageID, 'pyre_page_bg_repeat', true); ?>;
			...
			<?php endif; ?>
		<?php elseif($data['bg_image'] && ! get_post_meta($c_pageID, 'pyre_page_bg_color', true)): ?>
	...
	<?php if( ($data['header_transparent'] && get_post_meta(get_queried_object_id(), 'pyre_transparent_header', true) != 'no') ||
			  ( ! $data['header_transparent'] && get_post_meta(get_queried_object_id(), 'pyre_transparent_header', true) == 'yes') ): ?>
...
<body <?php body_class(array($avada_color_scheme,$body_class)); ?> data-spy="scroll">
		...
		<div class="page-title">
			<div class="page-title-wrapper">
				<div class="page-title-captions">
					...
					<?php else: ?>
					<?php echo get_the_title($c_pageID); ?>
					<?php endif; ?>
					</h1>
	...
	<div class="page-title-container">
		<div class="page-title">
			...
			<div class="page-title-captions">
			<?php if(get_post_meta($c_pageID, 'pyre_page_title_text', true) != 'no'): ?>
			<h1 class="entry-title"><?php echo get_the_title($c_pageID); ?></h1>
			<?php endif; ?>
			</div>
			<?php if($data['breadcrumb']): ?>
			<?php if($data['page_title_bar_bs'] == 'Breadcrumbs'): ?>
